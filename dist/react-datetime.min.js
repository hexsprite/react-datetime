...
!(function (e, t) {
  'object' == typeof exports && 'object' == typeof module
    ...
    ? define(['React', 'moment', 'ReactDOM'], t)
    ...
    : (e.Datetime = t(e.React, e.moment, e.ReactDOM))
})(this, function (e, t, n) {
  return (function (e) {
    function t(r) {
      ...
      var r = n(1),
        ...
        d = i({
          ...
          propTypes: {
            ...
            onBlur: p.func,
            onChange: p.func,
            onViewModeChange: p.func,
            onNavigateBack: p.func,
            onNavigateForward: p.func,
            locale: p.string,
            utc: p.bool,
            displayTimeZone: p.string,
            input: p.bool,
            inputProps: p.object,
            timeConstraints: p.object,
            viewMode: p.oneOf([l.YEARS, l.MONTHS, l.DAYS, l.TIME]),
            isValidDate: p.func,
            open: p.bool,
            strictParsing: p.bool,
          ...
          getInitialState: function () {
            ...
            return (
              ...
              (e.currentView = this.props.dateFormat
                ? this.props.viewMode || e.updateOn || l.DAYS
                : l.TIME),
          ...
          parseDate: function (e, t) {
            ...
            return (
              e && 'string' == typeof e
                ? (n = this.localMoment(e, t.datetime))
          ...
          getStateFromProps: function (e) {
            ...
            return (
              (t = this.parseDate(a, i)),
              (n = this.parseDate(e.viewDate, i)),
              (n = t
                ? t.clone().startOf('month')
                : n
                ? n.clone().startOf('month')
                : this.localMoment().startOf('month')),
              (r = this.getUpdateOn(i)),
              (o = t
                ? t.format(i.datetime)
                : a.isValid && !a.isValid()
                ? ''
          ...
          getFormats: function (e) {
            ...
            return (
              t.date === !0
                ...
                : this.getUpdateOn(t) !== l.DAYS && (t.time = ''),
              t.time === !0 && (t.time = n.longDateFormat('LT')),
              (t.datetime =
          ...
          componentWillReceiveProps: function (e) {
            ...
            ;(e.utc === this.props.utc &&
              ...
              (e.utc
                ? (this.state.viewDate &&
                    (n.viewDate = this.state.viewDate.clone().utc()),
                  this.state.selectedDate &&
                    ((n.selectedDate = this.state.selectedDate.clone().utc()),
                    (n.inputValue = n.selectedDate.format(t.datetime))))
                : e.displayTimeZone
                ? (this.state.viewDate &&
                    (n.viewDate = this.state.viewDate
                      .clone()
                      .tz(e.displayTimeZone)),
                  this.state.selectedDate &&
                    ((n.selectedDate = this.state.selectedDate
                      .clone()
                      .tz(e.displayTimeZone)),
                    (n.inputValue = n.selectedDate
                      .tz(e.displayTimeZone)
                      .format(t.datetime))))
                : (this.state.viewDate &&
                    (n.viewDate = this.state.viewDate.clone().local()),
                  this.state.selectedDate &&
                    ((n.selectedDate = this.state.selectedDate.clone().local()),
                    (n.inputValue = n.selectedDate.format(t.datetime))))),
              e.viewDate !== this.props.viewDate &&
                (n.viewDate = a(e.viewDate)),
              this.checkTZ(e),
              this.setState(n)
          },
          ...
          subtractTime: function (e, t, n) {
            var r = this
            return function () {
              r.props.onNavigateBack(e, t), r.updateTime('subtract', e, t, n)
            }
          },
          addTime: function (e, t, n) {
            var r = this
            return function () {
              r.props.onNavigateForward(e, t), r.updateTime('add', e, t, n)
            }
          },
          ...
          setTime: function (e, t) {
            var n,
              r = this.allowedSetTime.indexOf(e) + 1,
              o = this.state,
              i = (o.selectedDate || o.viewDate).clone()
            for (i[e](t); r < this.allowedSetTime.length; r++)
              (n = this.allowedSetTime[r]), i[n](i[n]())
            this.props.value ||
              this.setState({
                selectedDate: i,
                inputValue: i.format(o.inputFormat),
              }),
          ...
          updateSelectedDate: function (e, t) {
            var n,
              r = e.currentTarget,
              o = 0,
              i = this.state.viewDate,
              a = this.state.selectedDate || i
            if (
              (r.className.indexOf('rdtDay') !== -1
                ? (r.className.indexOf('rdtNew') !== -1
                    ? (o = 1)
                    : r.className.indexOf('rdtOld') !== -1 && (o = -1),
                  (n = i
                    .clone()
                    .month(i.month() + o)
                    .date(parseInt(r.getAttribute('data-value'), 10))))
                : r.className.indexOf('rdtMonth') !== -1
                ? (n = i
                    .clone()
                    .month(parseInt(r.getAttribute('data-value'), 10))
                    .date(a.date()))
                : r.className.indexOf('rdtYear') !== -1 &&
                  (n = i
                    .clone()
                    .month(a.month())
                    .date(a.date())
                    .year(parseInt(r.getAttribute('data-value'), 10))),
              n
                .hours(a.hours())
                .minutes(a.minutes())
                .seconds(a.seconds())
          ...
          localMoment: function (e, t, n) {
            ...
            return (
              (r = n.utc
                ? a.utc(e, t, n.strictParsing)
                : n.displayTimeZone
                ? a.tz(e, t, n.displayTimeZone)
          ...
          overrideEvent: function (e, t) {
            if (
              ...
              var n = this
              this.overridenEvents[e] = function (r) {
                var o
                n.props.inputProps &&
                  n.props.inputProps[e] &&
                  (o = n.props.inputProps[e](r)),
                  o !== !1 && t(r)
              }
            }
          ...
          render: function () {
            ...
            if (this.props.input) {
              ...
              t = this.props.renderInput
                ...
                : [s.createElement('input', r({ key: 'i' }, n))]
            } else e += ' rdtStatic'
            return (
              (this.props.open ||
      ...
      e.exports =
        ...
        function (e, t) {
          for (var o, i, a = n(e), s = 1; s < arguments.length; s++) {
            ...
            for (var c = 0; c < i.length; c++) a[i[c]] = o[i[c]]
          }
          return a
        }
    },
    ...
    function (e, t) {
      ...
      function a() {
        m &&
          f &&
          ((m = !1), f.length ? (h = f.concat(h)) : (y = -1), h.length && s())
      }
      function s() {
        if (!m) {
          var e = o(a)
            ...
            if (r) {
              ...
              for (var a in r)
                if (r.hasOwnProperty(a) && a !== l) {
                  ...
                  if ((d(p, a), w.hasOwnProperty(a))) w[a](e, u)
                  else {
                    var f = b.hasOwnProperty(a),
                      h = 'function' == typeof u,
                      m = h && !f && !p && r.autobind !== !1
                    if (m) i.push(a, u), (o[a] = u)
                      ...
                      s(
                        ...
                        'DEFINE_MANY_MERGED' === E
                          ? (o[a] = y(o[a], u))
                          : 'DEFINE_MANY' === E && (o[a] = v(o[a], u))
                    } else
                      (o[a] = u),
                        'production' !== t.env.NODE_ENV &&
                          'function' == typeof u &&
                          r.displayName &&
                          (o[a].displayName = r.displayName + '_' + a)
                  }
                }
          ...
          function E(e, n) {
            ...
            if ('production' !== t.env.NODE_ENV) {
              ...
              r.bind = function (a) {
                ...
                return (
                  (p.__reactBoundContext = e),
                  (p.__reactBoundMethod = n),
                  (p.__reactBoundArguments = u),
                  p
                )
              }
            }
          ...
          var O = [],
            ...
            w = {
              ...
              childContextTypes: function (e, n) {
                'production' !== t.env.NODE_ENV && p(e, n, 'childContext'),
                  (e.childContextTypes = i({}, e.childContextTypes, n))
              },
              contextTypes: function (e, n) {
                'production' !== t.env.NODE_ENV && p(e, n, 'context'),
              ...
              propTypes: function (e, n) {
                'production' !== t.env.NODE_ENV && p(e, n, 'prop'),
            ...
            _ = function () {}
          return i(_.prototype, e.prototype, k), D
        }
        var i = n(14),
          a = n(15),
          s = n(6)
        if ('production' !== t.env.NODE_ENV) var c = n(7)
        var u,
          l = 'mixins'
        ;(u =
          'production' !== t.env.NODE_ENV
    ...
    function (e, t, n) {
      ...
      var r = n(12),
        ...
        c = n(21),
        u = o({
          viewComponents: { days: i, months: a, years: s, time: c },
          render: function () {
        ...
        a = o({
              ...
              (e = [
                r.createElement('thead', { key: 'th' }, [
                  ...
                  r.createElement(
                    'tr',
                    { key: 'd' },
                    this.getDaysOfWeek(o).map(function (e, t) {
                      return r.createElement(
                        'th',
          ...
          renderDays: function () {
            var e,
              ...
              s = this.props.selectedDate && this.props.selectedDate.clone(),
              c = a.clone().subtract(1, 'months'),
              u = a.year(),
              l = a.month(),
              p = [],
              d = [],
              f = this.props.renderDay || this.renderDay,
              h = this.props.isValidDate || this.alwaysValidDate
            c.date(c.daysInMonth()).startOf('week')
            for (var m = c.clone().add(42, 'd'); c.isBefore(m); )
              (e = 'rdtDay'),
                (o = c.clone()),
                (c.year() === u && c.month() < l) || c.year() < u
                  ? (e += ' rdtOld')
                  : ((c.year() === u && c.month() > l) || c.year() > u) &&
                    (e += ' rdtNew'),
                s && c.isSame(s, 'day') && (e += ' rdtActive'),
                c.isSame(i(), 'day') && (e += ' rdtToday'),
                (t = !h(o, s)),
                t && (e += ' rdtDisabled'),
                (n = {
                  key: c.format('M_D'),
                ...
                d.push(f(n, o, s)),
                7 === d.length &&
                  (p.push(r.createElement('tr', { key: c.format('M_D') }, d)),
                  (d = [])),
                c.add(1, 'd')
            return p
          },
    ...
    function (e, t, n) {
      ...
      var o = n(12),
        ...
        a = i({
          render: function () {
            return o.createElement('div', { className: 'rdtMonths' }, [
              o.createElement(
                'table',
                { key: 'a' },
                o.createElement(
              ...
              o.createElement(
                'table',
                { key: 'months' },
                o.createElement('tbody', { key: 'b' }, this.renderMonths())
              ),
            ])
          },
          renderMonths: function () {
            for (
              var e,
                ...
                u = this.props.viewDate.month(),
                l = this.props.viewDate.year(),
                p = [],
                d = 0,
                f = [],
                h = this.props.renderMonth || this.renderMonth,
              ...
              (e = 'rdtMonth'),
                (n = this.props.viewDate
                  .clone()
                  .set({ year: l, month: d, date: y })),
                (i = n.endOf('month').format('D')),
                (a = Array.from({ length: i }, function (e, t) {
                  return t + 1
                })),
                (s = a.find(function (e) {
                ...
                (r = void 0 === s),
                r && (e += ' rdtDisabled'),
                c && d === c.month() && l === c.year() && (e += ' rdtActive'),
                (t = { key: d, 'data-value': d, className: e }),
                r ||
                  (t.onClick =
                    'months' === this.props.updateOn
                      ? this.updateSelectedMonth
                      : this.props.setDate('month')),
                f.push(h(t, d, l, c && c.clone())),
                4 === f.length &&
                  (p.push(
                    o.createElement('tr', { key: u + '_' + p.length }, f)
                  ),
                  (f = [])),
                d++
            return p
          ...
          renderMonth: function (e, t) {
            var n = this.props.viewDate,
              i = n.localeData().monthsShort(n.month(t)),
              a = 3,
              s = i.substring(0, a)
            return o.createElement('td', e, r(s))
          },
          alwaysValidDate: function () {
            return 1
          },
        ...
        i = o({
          ...
          renderYears: function (e) {
            var t,
              ...
              l = -1,
              p = [],
              d = this.props.renderYear || this.renderYear,
            ...
            for (e--; l < 11; )
              (t = 'rdtYear'),
                (o = this.props.viewDate
                  .clone()
                  .set({ year: e, month: m, date: y })),
                (a = o.endOf('year').format('DDD')),
                (s = Array.from({ length: a }, function (e, t) {
                  return t + 1
                })),
                (c = s.find(function (e) {
                  var t = o.clone().dayOfYear(e)
                  return h(t)
                })),
                (i = void 0 === c),
                i && (t += ' rdtDisabled'),
                f && f.year() === e && (t += ' rdtActive'),
                (n = { key: e, 'data-value': e, className: t }),
                i ||
                  (n.onClick =
                    'years' === this.props.updateOn
                      ? this.updateSelectedYear
                      : this.props.setDate('year')),
                u.push(d(n, e, f && f.clone())),
                4 === u.length &&
                  (p.push(r.createElement('tr', { key: l }, u)), (u = [])),
                e++,
                l++
            return p
          },
        ...
        a = o({
          ...
          calculateState: function (e) {
            var t = e.selectedDate || e.viewDate,
              n = e.timeFormat,
              r = []
            n.toLowerCase().indexOf('h') !== -1 &&
              (r.push('hours'),
              n.indexOf('m') !== -1 &&
                (r.push('minutes'), n.indexOf('s') !== -1 && r.push('seconds')))
            var o = t.format('H'),
              i = !1
            return (
              null !== this.state &&
            ...
            if ('daypart' !== e) {
              ...
              return (
                'hours' === e &&
                  this.props.timeFormat.toLowerCase().indexOf(' a') !== -1 &&
                  ((t = ((t - 1) % 12) + 1), 0 === t && (t = 12)),
                r.createElement('div', { key: e, className: 'rdtCounter' }, [
                  r.createElement(
                    'span',
                    {
                      key: 'up',
          ...
          render: function () {
            ...
            return (
              ...
              this.state.daypart !== !1 && t.push(e.renderDayPart()),
          ...
          componentWillMount: function () {
            ...
            ;(e.timeConstraints = {
              ...
              ['hours', 'minutes', 'seconds', 'milliseconds'].forEach(function (
                ...
                i(e.timeConstraints[t], e.props.timeConstraints[t])
              }),
          ...
          onStartClicking: function (e, t) {
            ...
            return function () {
              ...
              ;(r[t] = n[e](t)),
                ...
                document.body.addEventListener('touchend', n.mouseUpListener)
            }
          },
    ...
    function (e, t, n) {
          ...
          (r = n = (function (n) {
            function r() {
              ...
              for (var s = arguments.length, c = Array(s), u = 0; u < s; u++)
                c[u] = arguments[u]
              return (
                (e = t = i(this, n.call.apply(n, [this].concat(c)))),
                (t.__outsideClickHandler = null),
                (t.enableOnClickOutside = function () {
                  var e = t.__outsideClickHandler
                  if (e && 'undefined' != typeof document) {
                    ...
                    n.forEach || (n = [n]),
                      n.forEach(function (n) {
                        var r = null,
                          o = h.indexOf(n) !== -1
                        o && (r = { passive: !t.props.preventDefault }),
                          document.addEventListener(n, e, r)
                      })
                  }
                }),
            ...
            return (
              ...
              (r.prototype.componentDidMount = function () {
                if ('undefined' != typeof document && document.createElement) {
                  ...
                  if (t && 'function' == typeof t.handleClickOutside) {
                    if (
                      ((this.__clickOutsideHandlerProp = t.handleClickOutside(
                        e
                      )),
                    ...
                    c.Component.prototype.isPrototypeOf(e)
                      ? (this.__clickOutsideHandlerProp = e.handleClickOutside.bind(
                          e
                        ))
                      : (this.__clickOutsideHandlerProp = e.handleClickOutside)
                  else {
              ...
              (r.prototype.componentDidUpdate = function () {
                var e = (0, u.findDOMNode)(this.getInstance())
              ...
              (r.prototype.addOutsideClickHandler = function () {
                var e = (this.__outsideClickHandler = (0, p['default'])(
                    (0, u.findDOMNode)(this.getInstance()),
              ...
              (r.prototype.removeOutsideClickHandler = function () {
                this.disableOnClickOutside(), (this.__outsideClickHandler = !1)
                var e = d.indexOf(this)
                e > -1 && (f[e] && f.splice(e, 1), d.splice(e, 1))
              }),
      ...
      ;(t.__esModule = !0), (t.IGNORE_CLASS_NAME = void 0), (t['default'] = s)
      var c = n(12),
        u = n(23),
        l = n(24),
        p = r(l),
        ...
        m = (t.IGNORE_CLASS_NAME = 'ignore-react-onclickoutside')
    },
    function (e, t) {
      e.exports = n
    },
    function (e, t) {
      ...
      function i(e, t, n, i, a, s) {
        return function (c) {
          a && c.preventDefault(), s && c.stopPropagation()
          var u = c.target
          ;(i && o(c)) || r(u, e, n) !== document || t(c)
        }
      }
