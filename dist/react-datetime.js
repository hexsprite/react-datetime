  ...
  return /******/ (function (modules) {
	...
	*/
        ...
        var DateTimePickerMonths = createClass({
          ...
          renderMonths: function () {
            ...
            while (i < 12) {
              ...
              daysInMonth = Array.from({ length: noOfDaysInMonth }, function (
                e,
                i
              ) {
                return i + 1
        ...
        var DateTimePickerYears = createClass({
          ...
          renderYears: function (year) {
            ...
            while (i < 11) {
              ...
              daysInYear = Array.from({ length: noOfDaysInYear }, function (
                e,
                i
              ) {
                return i + 1
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _generateOutsideCheck2 = _interopRequireDefault(
          _generateOutsideCheck
        )
        ...
        var IGNORE_CLASS_NAME = (exports.IGNORE_CLASS_NAME =
        ...
        function onClickOutsideHOC(WrappedComponent, config) {
          ...
          return (
            (_temp2 = _class = (function (_Component) {
                ...
                return (
                  (_ret =
                    ((_temp =
                      ...
                      _this)),
                    (_this.__outsideClickHandler = null),
                    (_this.enableOnClickOutside = function () {
                      ...
                      if (fn && typeof document !== 'undefined') {
                        ...
                        events.forEach(function (eventName) {
                          ...
                          var isTouchEvent =
                            touchEvents.indexOf(eventName) !== -1
              ...
              onClickOutside.prototype.componentDidMount = function componentDidMount() {
                ...
                if (config && typeof config.handleClickOutside === 'function') {
                  ...
                  if (_react.Component.prototype.isPrototypeOf(instance)) {
                    this.__clickOutsideHandlerProp = instance.handleClickOutside.bind(
                      instance
                    )
                  } else {
                  ...
                  typeof instance.props.handleClickOutside === 'function'
                ) {
              ...
              onClickOutside.prototype.componentWillReceiveProps = function componentWillReceiveProps(
                nextProps
              ) {
                if (
                  this.props.disableOnClickOutside &&
                  !nextProps.disableOnClickOutside
                ) {
              ...
              onClickOutside.prototype.componentDidUpdate = function componentDidUpdate() {
                var componentNode = (0, _reactDom.findDOMNode)(
                  this.getInstance()
                )
              ...
              onClickOutside.prototype.addOutsideClickHandler = function addOutsideClickHandler() {
                var fn = (this.__outsideClickHandler = (0,
                _generateOutsideCheck2.default)(
                  (0, _reactDom.findDOMNode)(this.getInstance()),
                  this.__clickOutsideHandlerProp,
        ...
        function generateOutsideCheck(
          ...
          return function (evt) {
            ...
            if (
              ...
              findHighest(current, componentNode, ignoreClass) !== document
            ) {
              return
            }
            eventHandler(evt)
